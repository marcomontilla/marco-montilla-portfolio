/**
 * BorderGlowCard
 * Ported from ReactBits (MIT) — https://reactbits.dev/components/border-glow
 *
 * Key requirement: --card-bg MUST be set via inline style (not CSS class)
...
export interface BorderGlowCardProps {
  children?: ReactNode
  /** Applied to the outer wrapper (.border-glow-card) */
  className?: string
  /** Applied to the inner content div (.border-glow-inner) */
  innerClassName?: string
  edgeSensitivity?: number
  /** HSL triplet — e.g. "40 80 80". Maps to glow hue/sat/light. */
  glowColor?: string
  /**
   * Solid background color for the card.
   * MUST be opaque — semi-transparent values break ::before masking.
   * Defaults to dark-surface (#0d1426) in dark mode, pale blue-white in light.
   */
  ...
  coneSpread?: number
  /** Run a one-shot sweep animation on mount */
  animated?: boolean
  /** Mesh-gradient fill colors [primary, secondary, tertiary] */
  colors?: string[]
  fillOpacity?: number
}
